      ...
      <?php
        foreach ($usuarios as $usuario) {
            ...
            <tr>
                ...
                <td><textarea class="form-control" name="about" rows="3" placeholder="about" id="about">{{$usuario->about}}</textarea></td>
                ...
                <td><input type="submit" name="eliminar" value="Eliminar" class="btn btn-danger"></td>
              </tr>
            </form>
            <?php
        }
